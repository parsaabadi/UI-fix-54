...
import RunWorksetSelector from 'components/RunWorksetSelector.vue'
...
export default {
  ...
  methods: {
    ...
    onRunSelectionChange (newRunDigest) {
      if (newRunDigest && newRunDigest !== this.runDigestSelected) {
        this.$router.push('/model/' + this.digest + '/run/' + newRunDigest)
      }
    },
    onWorksetSelectionChange (newWorksetName) {
      if (newWorksetName && newWorksetName !== this.worksetNameSelected) {
        this.$router.push('/model/' + this.digest + '/set/' + newWorksetName)
      }
    },
